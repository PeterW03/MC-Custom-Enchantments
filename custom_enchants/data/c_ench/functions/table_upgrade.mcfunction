...
execute as @s run summon minecraft:item_frame ~ ~ ~ {Tags:["smithing_table"]}
execute as @s run tp @s @e[tag=smithing_table,limit=1,distance=..1]
execute as @s run summon armor_stand ~ ~ ~ {Tags:["smithing_table2", "smithing_table_exec"], Invisible:1b}
